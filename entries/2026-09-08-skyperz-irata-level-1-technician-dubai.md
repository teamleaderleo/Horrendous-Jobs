...
**Expected hours:** Not stated  
**First observed:** 2026-09-08  
**Last observed:** 2026-09-08  
**Posting status:** unknown  
**Repost count:** 0  
**Days in the Wild:** 0  
**Source:** [LinkedIn Jobs](https://ae.linkedin.com/jobs/view/irata-level-1-technician-at-skyperz-building-cleaning-services-co-l-l-c-4393601115)

## The posting

SKYPERZ advertises an on-site IRATA Level 1 Technician in Dubai for façade and high-rise cleaning using rope-access techniques. The role pays **AED 1,600–1,900/month** based on experience; accommodation and transportation are provided. LinkedIn currently shows the listing but says applications are no longer being accepted.

### Advertised responsibilities

- Perform façade and high-rise cleaning using rope access.
- Clean glass, windows, and other high-elevation surfaces.
- Follow IRATA safety protocols.
- Inspect and maintain equipment.
- Collaborate with team members on-site.

### Advertised requirements

- Active IRATA Level 1 certification.
- Rope-access proficiency.
- High-rise façade, glass, and window-cleaning skills.
- Equipment inspection and maintenance familiarity.
- Safety-protocol knowledge.
- Physical fitness and stamina.
- Basic workplace English.
- Previous high-rise cleaning experience is an advantage.

## Scorecard

| Dimension | Score / 5 | Evidence |
|---|---:|---|
| Scope creep | 1 | Coherent rope-access cleaning role |
| Responsibility / authority gap | 4 | Worker carries immediate personal safety responsibility while operating within site systems |
| Coordination burden | 2 | Team-based rope-access and safety coordination |
...
> Active IRATA certification required to hang outside Dubai towers for AED 1,600–1,900/month.
